          ...
          <div className="custom-scrollbar min-h-0 flex-1 overflow-y-auto p-6" ref={messagesContainerRef} onScroll={handleMessagesScroll}>
            <div className="flex min-h-full flex-col gap-6">
              ...
              {hasActiveConversation && isLoadingOlderMessages ? (
                <div className="flex justify-center">
                  <span className="rounded-full bg-slate-200 px-3 py-1 text-[11px] font-semibold text-slate-500">Đang tải thêm 10 tin cũ...</span>
                </div>
              ) : null}

              {hasActiveConversation && !isLoadingOlderMessages && hasMoreMessages ? (
                <div className="flex justify-center">
                  <span className="rounded-full bg-slate-100 px-3 py-1 text-[11px] font-medium text-slate-400">Lướt lên đầu để tải thêm 10 tin nhắn cũ</span>
                </div>
              ) : null}
